...
//        NSLog(@"random... %@", [Utilities getRandomStringCode:5]);
//        NSLog(@"random... %@", [Utilities getRandomStringCode:3]);
//        NSLog(@"random... %@", [Utilities getRandomStringCode:8]);
